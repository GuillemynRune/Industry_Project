// Enhanced Speech Recognition System with Opera support
class SpeechRecognitionManager {
    ...
    enhanceTextarea(textarea) {
        ...
        micBtn.addEventListener('click', () => {
            if (!isSupported) {
                showToast('Speech recognition is not supported in Opera browser. Please try Chrome, Edge, or Safari.', 'warning', 'Browser Not Supported');
                return;
            }
